...
export const PAGE_HELP: Array<{ pattern: string; key: string }> = [
  ...
  { pattern: '/farm/livestock/:livestockId/breeding', key: 'breeding' },
  { pattern: '/farm/livestock/:livestockId/movement', key: 'livestockMovement' },
  { pattern: '/farm/livestock/:id', key: 'livestockDetail' },
  { pattern: '/export', key: 'farmExport' },
  { pattern: '/farm/stock', key: 'stock' },
  { pattern: '/farm/stock/balance', key: 'balance' },
  { pattern: '/farm/stock/:id', key: 'stockHistory' },
  { pattern: '/harvest/timeline', key: 'harvestTimeline' },
  { pattern: '/farm/seeds/:id', key: 'seedHistory' },
  { pattern: '/farm/fruits', key: 'fruits' },
  { pattern: '/farm/fruits/balance', key: 'balance' },
  { pattern: '/farm/fruits/treatment', key: 'treatment' },
  { pattern: '/farm/fruits/harvest', key: 'fruitHarvest' },
  { pattern: '/farm/fruits/harvest/:id', key: 'fruitHarvestDetail' },
  { pattern: '/farm/fruits/products', key: 'treeProducts' },
  { pattern: '/farm/fruits/products/:id', key: 'treeProductHistory' },
  { pattern: '/farm/fruits/:id', key: 'fruitsHistory' },
  { pattern: '/farm/greenhouse', key: 'greenhouse' },
  { pattern: '/farm/greenhouse/balance', key: 'balance' },
  { pattern: '/farm/greenhouse/stock', key: 'greenhouseStock' },
  { pattern: '/farm/greenhouse/seeds', key: 'greenhouseSeeds' },
  { pattern: '/farm/greenhouse/harvest', key: 'greenhouseHarvest' },
  { pattern: '/farm/greenhouse/harvest/:id', key: 'greenhouseHarvestDetail' },
  { pattern: '/farm/greenhouse/:id', key: 'greenhouseDetail' },
  { pattern: '/farm/equipment', key: 'equipment' },
  { pattern: '/farm/types', key: 'kindTypes' },
  { pattern: '/map', key: 'map' },
  { pattern: '/purchases', key: 'purchases' },
  { pattern: '/sales', key: 'sales' },
  { pattern: '/manager', key: 'manager' },
