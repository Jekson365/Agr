...
import { updateGreenhouseHarvest } from '@/services/greenhouse-harvest-service';
...
type Props = {
  ...
  onClose: () => void;
  onSaved: (harvest: GreenhouseHarvest) => void;
};
...
/** The greenhouse counterpart to HarvestExpensesModal. */
export function GreenhouseHarvestExpensesModal({ open, harvest, onClose, onSaved }: Props) {
  const { t } = useLanguage();
