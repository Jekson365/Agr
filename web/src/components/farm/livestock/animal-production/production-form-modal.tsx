...
export function ProductionFormModal({
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        className={form.isRealization ? 'modal-card wide xwide' : 'modal-card wide'}
      ...
      >
        ...
        <div className="form-fields modal-form-split">
          <div className="modal-form-part">
          ...
          {error && <div className="error-banner modal-form-span">{error}</div>}
        </div>
