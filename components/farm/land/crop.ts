import { stockKindImage, STOCK_KIND_IMAGE, STOCK_TYPE_LABEL_KEY } from '@/components/farm/stock/stock';
import { FRUIT_KIND_IMAGE, FRUIT_TYPE_LABEL_KEY } from '@/components/farm/tree-stock/tree-stock';
 ...
 * generic default. */
export function cropImage(crop: string): number {
